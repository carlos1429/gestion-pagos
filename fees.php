...
<script>
	...
	$('#new_fees').click(function() {
		uni_modal("Inscribir Usuario ", "manage_fee.php", "mid-large")

	})
	$('.edit_fees').click(function() {
		uni_modal("Administrar los detalles de inscripción del Usuario", "manage_fee.php?id=" + $(this).attr('data-id'), "mid-large")
