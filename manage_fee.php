...
<div class="container-fluid">
	<form id="manage-fees">
		...
		<div class="form-group">
			<label for="" class="control-label">Nº Matrícula/ Nº Evento</label>
		...
		<div class="form-group">
			<label for="" class="control-label">Evento</label>
		...
		$.ajax({
			...
			success: function(resp) {
				if (resp == 1) {
					...
					$('#msg').html('<div class="alert alert-danger">Número de Evento Existe Actualmente</div>')
					end_load()
				}
			}
		})
