...
<script>
	...
	$('#new_student').click(function() {
		uni_modal("Nuevo Contacto ", "manage_student.php", "mid-large")

	})
	$('.edit_student').click(function() {
		uni_modal("Gestionar Información de Contacto", "manage_student.php?id=" + $(this).attr('data-id'), "mid-large")

	})
	$('.delete_student').click(function() {
		_conf("Deseas eliminar este Contacto? ", "delete_student", [$(this).attr('data-id')])
	})
