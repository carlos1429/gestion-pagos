			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>Lista de Eventos y tarifas</b>
...
<script>
	...
	$('#new_course').click(function() {
		uni_modal("Entrada de nuevos Eventos y tarifas", "manage_course.php", 'large')

	})

	$('.edit_course').click(function() {
		uni_modal("Administrar la entrada de Eventos y tarifas", "manage_course.php?id=" + $(this).attr('data-id'), 'large')

	})
	$('.delete_course').click(function() {
		_conf("¿Deseas eliminar este Evento?", "delete_course", [$(this).attr('data-id')])
	})
